...
namespace Iteris {
	...
	/// </code>
	/// </example>
	[SuppressMessage("Microsoft.Naming", "CA1710:IdeNOTIFfiersShouldHaveCorrectSuffix", Justification = "From MSDN: It is safe to suppress a warning to use the 'Collection' suffix if the type is a generalized data structure that might be extended or that will hold an arbitrary set of diverse items. (which is the case here) - http://msdn.microsoft.com/en-us/library/ms182244.aspx")]
	[Serializable]
